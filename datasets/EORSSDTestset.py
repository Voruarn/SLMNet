...
class EORSSDDataset(torch.utils.data.Dataset):
    """一个用于加载 EORSSD 和 ORSSD 测试集的自定义数据集"""

    def __init__(self, is_train, voc_dir, trainsize=320):
        ...
        for fname in tqdm(images):
            if fname=='':
                continue
            features.append(voc_dir+'/Images/'+f'{fname}.jpg')
