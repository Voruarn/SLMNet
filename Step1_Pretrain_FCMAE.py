...
from util6.pos_embed import interpolate_pos_embed


from timm.models import create_model
import timm.models
from fcmae_model import convnextv2_tiny, convnextv2_small, convnextv2_base
...
def get_args_parser():
    ...
    parser.add_argument('--model', default='convnextv2_tiny', type=str, metavar='MODEL',
                        help='Name of model to train:[convnextv2_tiny, convnextv2_small, convnextv2_base]')
    ...
    parser.add_argument('--output_dir', default='./Pretrain_FCMAE',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./Pretrain_FCMAE',
...
def main(args):
   ...
   #  print("Model = %s" % str(model_without_ddp))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch+1) % 5 == 0:
            save_model(args.output_dir+'/latest_{}.pth'.format(args.model))
            if (epoch+1) % 50 == 0:
                save_model(args.output_dir+'/{}_ep{}.pth'.format(args.model, epoch+1))
